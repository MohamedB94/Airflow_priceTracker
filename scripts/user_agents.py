"""
Collection of user agents for web scraping.
Helps avoid detection and blocking by rotating through different browser signatures.
"""
...
USER_AGENTS = [
    ...
    "Mozilla/5.0 (iPhone14,6; U; CPU iPhone OS 16_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.3 Mobile/15E148 Safari/604.1",
    "Mozilla/5.0 (iPhone14,3; U; CPU iPhone OS 16_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.2 Mobile/15E148 Safari/604.1"
]
